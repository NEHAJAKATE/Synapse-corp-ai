<!-- spiderbrain:start v=1 fp=4e4941819977a67a commit=08deb558baeb -->
## Repo understanding (SpiderBrain)

This repo carries a committed brain in `.spiderbrain/`: a deterministic, source-free map of its
structure, dependencies, and blast radius (48 files, 36 edges). Consult it before
...
Deterministic: regenerates byte-identically from commit 08deb558baeb (fingerprint 4e4941819977a67a). Do not hand-edit between the markers.
<!-- spiderbrain:end -->
